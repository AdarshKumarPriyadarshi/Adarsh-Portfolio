...
const experienceData: Experience[] = [
  ...
  },
  {
    ...
    description: [
      'Worked on a Proof of Concept (POC) for Automated Parking Assist (APA), focusing on data parsing, cleaning, and preparing datasets for LLM-based automation.',
      'Gained hands-on experience with automation fundamentals, including different automation levels, ADAS features, and their classifications.',
      'Worked with CI/CD pipelines and containerization using Docker; collaborated using Git and GitLab for version control and workflow automation.',
      'Developed a small-scale Smart Life Manager project involving Python automation, voice assistants, and system integration.'
    ]
  }
