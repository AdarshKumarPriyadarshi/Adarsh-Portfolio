...
const projectsData: Project[] = [
  ...
  },
  {
    ...
    image: "Smart_Life_Manager.png",
    tech: ["FastAPI", "Python", "SQLite", "Requests", "Open-Meteo API", "CLI", "Pydantic"],
    githubUrl: "https://github.com/AdarshKumarPriyadarshi/Smart_Life_Manager",
    liveUrl: "http://53.217.101.197:8081/",
    fullDescription: "Complete personal productivity platform featuring task CRUD operations, notes management, date-based reminders, real-time weather for any city with history tracking, and intuitive CLI interface connected to FastAPI REST backend.",
    problem: "Fragmented productivity tools requiring multiple apps for tasks, notes, reminders, and weather info, with no unified CLI experience or persistent data storage across sessions.",
